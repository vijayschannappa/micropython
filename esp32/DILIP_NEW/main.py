...
def read_load_survey_data(Meter_time_Serial_Number):
    with open("data.json", "r") as data:
        ...
        for data in string["LOAD_PARAMETERS"]:
            ...
            if parameters_name == "Load_Time":
                lsd.pull_load_survey_data(Meter_time_Serial_Number[0],
                                          Meter_time_Serial_Number[1],
                                          Meter_time_Serial_Number[2],
                                          Add_Minutes,Time_Difference_Minutes)
    
if __name__ == '__main__':
    while True:
        Meter_time_Serial_Number = obis.obis_code_generation()
        read_load_survey_data(Meter_time_Serial_Number)
